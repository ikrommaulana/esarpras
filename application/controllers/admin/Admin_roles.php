...
class Admin_roles extends CI_Controller
{
	...
	{   
		...
		$this->session->set_flashdata('msg','Admin roles has been Deleted.');	
	...
	function edit($id="")
	{
		...
		if($this->input->post('submit'))
		{
			...
			$this->session->set_flashdata('msg','Admin roles has been Updated.');		
			redirect('admin/admin_roles');
		}
	...
	function access($id="")
	{
		...
		$data['modules']= $this->admin_roles->get_modules_parent();
