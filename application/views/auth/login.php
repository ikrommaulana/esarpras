...
<html lang="en">
    <head>
          <title><?=isset($title)?$title:'Login - E-Sarpras' ?></title>
    ...
    <body id="login-form">
        <div class="container">
              <div class="col-md-4" style="position:absolute;top:10px;right:10px;">
                  <img src="<?= base_url() ?>public/dist/img/logo_bppt.png" style="width:50%;float:right">
              </div>
            <div class="row">
                
                <div class="col-md-4 col-md-offset-4 text-center">
                    <div class="login-title">
                        <h3><span>E-Sarpras</span></h3>
                    </div>
