      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/lab/add'), 'class="form-horizontal"');  ?> 
              <div class="form-group">
                <label for="nama_lab" class="col-sm-2 control-label">Nama Lab</label>
                <div class="col-sm-9">
                  <input type="text" name="nama_lab" class="form-control" id="nama_lab" placeholder="">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="id_unitkerja" class="form-control">
                    ...
                    <option value="<?=$row->id_unitkerja;?>"><?='['.$row->kode_unitkerja.'] '.$row->nama_unitkerja;?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="id_lokasi" class="form-control">
                    ...
                    <option value="<?=$row->id_lokasi;?>"><?= '['.$row->kode_lokasi.']'.$row->nama_lokasi; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              <div class="form-group">
                <div class="col-md-11">
                  <input type="submit" name="submit" value="Add Laboratorium" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          </div>
