      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open_multipart(base_url('admin/sert_pegawai/edit/'.$sert_pegawai['id_sert_detail']), 'class="form-horizontal"' )?>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="nip" class="form-control">
                    ...
                    <option value="<?=$row->nip;?>" <?= $row->nip==$sert_pegawai['sertifikat_user']? 'selected':'' ?>><?=$row->nama_pegawai;?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="id_sertifikat" class="form-control">
                    ...
                    <option value="<?=$row->id_sertifikat;?>" <?= $row->id_sertifikat==$sert_pegawai['id_sertifikat']? 'selected':'' ?>><?=$row->kode_sertifikat;?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="masa_berlaku" class="form-control datepicker" id="masa_berlaku" value="<?=date("m/d/Y", strtotime($sert_pegawai['masa_berlaku']));?>">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-md-11">
                  <input type="submit" name="submit" value="Update Sertifikat Pegawai" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          </div>
