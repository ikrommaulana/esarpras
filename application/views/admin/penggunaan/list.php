        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              <!--a title="View" class="update btn btn-sm btn-default" href="<?=base_url('admin/'.$page.'/view/'.$row['lanjasidpermohonan']);?>"> <i class="fa fa-eye"></i></a-->
              <?php 
                if(($this->session->userdata('admin_id')==$row['created_by']) or ($this->session->userdata('admin_role')=='superadmin') or ($this->session->userdata('priviledge')==2) or ($this->session->userdata('priviledge')==3)){
              echo '<a title="Edit" class="update btn btn-sm btn-warning" href="'.base_url('admin/'.$page.'/edit/'.$row['lanjasidpermohonan']).'"> <i class="fa fa-pencil-square-o"></i></a>
