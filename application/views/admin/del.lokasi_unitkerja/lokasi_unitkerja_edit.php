      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/lokasi_unitkerja/edit/'.$lokasi_unitkerja['id_lokasi_unitkerja']), 'class="form-horizontal"' )?> 
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="id_unitkerja" class="form-control">
                    ...
                    <option value="<?=$row->id_unitkerja;?>" <?= $row->id_unitkerja==$lokasi_unitkerja['id_unitkerja']? 'selected':'' ?>><?=$row->nama_unitkerja;?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="id_sertifikat" class="form-control">
                    ...
                    <option value="<?=$row->id_lokasi;?>"  <?= $row->id_lokasi==$lokasi_unitkerja['id_lokasi']? 'selected':'' ?>><?=$row->nama_lokasi;?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="telp" class="form-control" id="telp" value="<?=$lokasi_unitkerja['telp']?>">
                </div>
              </div>
              <div class="form-group">
                <div class="col-md-11">
                  <input type="submit" name="submit" value="Update Lokasi Unit Kerja" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          </div>
