  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-body">
        <div class="col-md-6">
          <h4><i class="fa fa-list"></i> &nbsp; Personil Pendidikan</h4>
        </div>
        <div class="col-md-6 text-right">
         <?php if($this->rbac->check_operation_permission('add')): ?>
          <a href="<?= base_url('admin/personil_pendidikan/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Personil Pendidikan</a>
         <?php endif; ?>
        </div>
   ...
   <div class="box">
    ...
    <div class="box-body table-responsive">
      <table id="menu_table" class="table table-bordered table-striped ">
        ...
        <tbody>
          <?php $i=0; foreach($all_personil_pendidikan as $row): 
          ...
          <tr>
            ...
            <td class="text-center"><?php echo '<a title="Edit" class="update btn btn-sm btn-warning" href="'.base_url('admin/personil_pendidikan/edit/'.$row['idpdk']).'"> <i class="fa fa-pencil-square-o"></i></a>
                   <a title="Delete" class="delete btn btn-sm btn-danger" data-href="'.base_url('admin/personil_pendidikan/delete/'.$row['idpdk']).'" data-toggle="modal" data-target="#confirm-delete"> <i class="fa fa-trash-o"></i></a>' ;?>
...
<script>
  $("body").on("change",".tgl_checkbox",function(){
    $.post('<?=base_url("admin/personil_pendidikan/change_status")?>',
    {
...
<script>
    $("#personil_pendidikan").addClass('active');
  </script>
