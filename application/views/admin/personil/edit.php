      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <!--?php echo form_open_multipart(base_url('admin/personill/add'), 'class="form-horizontal"');  ?--> 
            <?php echo form_open_multipart(base_url('admin/personil/edit/'.$personil['id_personil']), 'class="form-horizontal"' )?> 
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="PegNIP" class="form-control" id="PegNIP" value="<?=$personil['pegnip'];?>">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <img src="<?=base_url();?>uploads/images/personil/<?= $personil['pegphoto']; ?>" style="height:250px;margin-bottom:5px;border-radius:4px"/>
