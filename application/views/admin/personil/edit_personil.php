...
$adm = $this->db->query('select * from ci_admin where admin_id!=1 and is_active=1 order by admin_id asc')->result();
  ...
  <div class="row">
   ...
   <div class="box">
    ...
    <div class="box-body table-responsive">
      <div class="row">
        <div class="col-md-12">
          <img class="profile-user-img img-responsive" src="<?=base_url();?>uploads/images/personil/<?= $personil['pegphoto'];?>" alt="Photo <?=$personil['pegnama'];?>" style="">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <!--li><a href="#tab_5" data-toggle="tab">Admin</a></li-->
            </ul>
                  ...
                  <div class="col-md-12">
                    ...
                    <?php echo form_open_multipart(base_url('admin/'.$page.'/edit/'.$personil['id_personil']), 'class="form-horizontal"' )?> 
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="PegNama" class="form-control" id="PegNama" value="<?=$personil['pegnama'];?>" onkeyup="this.value = this.value.toUpperCase();">
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="PegEmail" class="col-sm-3 control-label">Email Pegawai</label>
                          <div class="col-sm-9">
                            <input type="text" name="PegEmail" class="form-control" id="PegEmail" value="<?=$personil['pegemail'];?>" onkeyup="this.value = this.value.toUpperCase();">
                          </div>
                        </div>
                        <!--div class="form-group">
                          <label for="PegAsal" class="col-sm-3 control-label">Asal Pegawai</label>
                          <div class="col-sm-9">
                            <input type="text" name="PegAsal" class="form-control" id="PegAsal" value="<?=$personil['pegasal'];?>" onkeyup="this.value = this.value.toUpperCase();">
                          </div>
                        </div>
                        <div class="form-group">
              ...
              <div class="tab-pane" id="tab_2">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <a href="<?= base_url("admin/personil_pendidikan/add/".$personil['pegnip']); ?>" name="addPdk" class="btn btn-info pull-right">Tambah Pendidikan</a>
                  </div>
                </div>
              </div>
              <!-- /.tab-pane -->
              <div class="tab-pane" id="tab_3">
               <div class="row">
                  <div class="col-md-12">
                    ...
                    <a href="<?= base_url("admin/sert_personil/add/".$personil['pegnip']); ?>" name="addSert" class="btn btn-info pull-right">Tambah Sertifikat</a>
                  </div>
                </div>
              </div>
              <!-- /.tab-pane -->
              <div class="tab-pane" id="tab_4">
               <div class="row">
                  <div class="col-md-12">
                    ...
                    <a href="<?= base_url("admin/personil_training/add/".$personil['pegnip']); ?>" name="addTra" class="btn btn-info pull-right">Tambah Training</a>
                  </div>
                </div>
              </div>
              <!-- /.tab-pane -->
              <div class="tab-pane active" id="tab_5">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <!--?php echo form_open(base_url('admin/'.$page.'/edit/'.$personil['id_personil']), 'class="form-horizontal"' )?>
                        <div class="form-group">
                          <label for="AdminId" class="col-sm-3 control-label">Login</label>
                          <div class="col-sm-9">
                            <select name="AdminId" class="form-control">
                              <option value="">Pilih Administrator</option>
                              <?php foreach($adm as $row){?>
                              <option value="<?=$row->admin_id;?>" <?=$personil['admin_id']==$row->admin_id?'selected':'';?>><?=$row->username;?></option>
                              <?php } ?>
                            </select>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-md-12">
                            <input type="submit" name="submitAdm" value="Simpan Perubahan" class="btn btn-info pull-right">
                          </div>
                        </div>
                    </div>
                  </div>
