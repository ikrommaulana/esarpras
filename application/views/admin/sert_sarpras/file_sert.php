...
<link rel="stylesheet" href="<?= base_url() ?>public/plugins/datatables/dataTables.bootstrap.css">  
 ...
 <section class="content">
    ...
    <div class="col-md-12">
      <div class="box box-body">
        ...
        <div class="col-md-6 text-right">
          <a href="<?= base_url('admin/sert_sarpras'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Sertifikat Sarpras List</a>
        </div>
  ...
  <?php 
    $file_sert = base_url().'uploads/files/'.$sert['file_sert'];
  ?>
