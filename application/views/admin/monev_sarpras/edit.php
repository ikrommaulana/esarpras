  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-body with-border">
        <div class="col-md-6">
          <h4><i class="fa fa-plus"></i> &nbsp; Edit <?=$title;?></h4>
        </div>
          ...
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open_multipart(base_url('admin/'.$page.'/edit/'.$data['id_monev']), 'class="form-horizontal"' )?> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="MonevSifat" class="form-control">
                    ...
                    <option value="INTERNAL" <?=$data['monevsifat']=='INTERNAL'?'selected':'';?>>Internal</option>
                    <option value="EKSTERNAL" <?=$data['monevsifat']=='EKSTERNAL'?'selected':'';?>>Eksternal</option>
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="MonevPelak" class="form-control">
                    ...
                    <option value="<?=$row->pegnip;?>" <?=$data['monevpelak']==$row->pegnip?'selected':'';?>><?=$row->pegnama;?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="MonevTglMul" class="form-control datepicker" id="MonevTglMul" value="<?= date('m/d/Y',strtotime($data['monevtglmul']));?>">
                </div>
              </div>
              <div class="form-group">
                <label for="MonevTglSel" class="col-sm-2 control-label">Tanggal Selesai</label>
                <div class="col-sm-9">
                  <input type="text" name="MonevTglSel" class="form-control datepicker" id="MonevTglSel" value="<?= date('m/d/Y',strtotime($data['monevtglsel']));?>">
                </div>
              </div>
              <div class="form-group">
                <label for="MonevCatatan" class="col-sm-2 control-label">Catatan</label>
                <div class="col-sm-9">
                  <input type="text" name="MonevCatatan" class="form-control" id="MonevCatatan" value="<?= $data['monevcatatan'];?>">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <select name="MonevStatus" class="form-control">
                    <option value="BAIK" <?=$data['monevstatus']=='BAIK'?'selected':'';?>>BAIK</option>
                    <option value="RUSAK RINGAN" <?=$data['monevstatus']=='RUSAK RINGAN'?'selected':'';?>>RUSAK RINGAN</option>
                    <option value="RUSAK BERAT" <?=$data['monevstatus']=='RUSAK BERAT'?'selected':'';?>>RUSAK BERAT</option>
                  </select>
              </div>
              </div>
              <div class="form-group">
