                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="MitraInst" class="form-control" id="MitraInst" value="<?=$data['mitrainst'];?>" onkeyup="this.value = this.value.toUpperCase();" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="MitraKat" class="col-sm-3 control-label">Kategori</label>
                      <div class="col-sm-9">
                        <input type="text" name="MitraInst" class="form-control" id="MitraInst" value="<?=$data['mitrakat'];?>" onkeyup="this.value = this.value.toUpperCase();" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="MitraBid" class="col-sm-3 control-label">Bidang/Spec Teknis</label>
                      <div class="col-sm-9">
                        <input type="text" name="MitraBid" class="form-control" id="MitraBid" value="<?=$data['mitrabid'];?>" onkeyup="this.value = this.value.toUpperCase();" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="MitraPIC" class="col-sm-3 control-label">Nama PIC</label>
                      <div class="col-sm-9">
                        <input type="text" name="MitraPIC" class="form-control" id="MitraPIC" value="<?=$data['mitrapic'];?>" onkeyup="this.value = this.value.toUpperCase();" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="MitraAlamat" class="col-sm-3 control-label">Alamat</label>
                      <div class="col-sm-9">
                        <input type="text" name="MitraAlamat" class="form-control" id="MitraAlamat" value="<?=$data['mitraalmt'];?>" onkeyup="this.value = this.value.toUpperCase();" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="MitraTelp" class="col-sm-3 control-label">Telepon</label>
                      <div class="col-sm-9">
                        <input type="text" name="MitraTelp" class="form-control" id="MitraTelp" value="<?=$data['mitratelp'];?>" onkeyup="this.value = this.value.toUpperCase();" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="MitraEmail" class="col-sm-3 control-label">Email</label>
                      <div class="col-sm-9">
                        <input type="text" name="MitraEmail" class="form-control" id="MitraEmail" value="<?=$data['mitraemail'];?>" onkeyup="this.value = this.value.toUpperCase();" readonly>
                      </div>
                    </div>
                    </div>
                  </div>
                     ...
                     <thead>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?= $row['konmitttd']; ?></td>
                          <td class="text-center"><?php echo '<a title="View" class="btn btn-sm btn-primary" href="'.base_url('admin/kontrak_mitra/view/'.$row['konmitid']).'"> <i class="fa fa-file-pdf-o"></i></a>';?></td>
                        </tr>
                        <?php endforeach; ?>
                      </tbody>
                    </table>
