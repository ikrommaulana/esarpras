      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <!--?php echo form_open(base_url('admin/'.$page.'/edit/'.$data['hasil_id']), 'class="form-horizontal"' )?--> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="JadPemSifat" class="form-control" id="JadPemSifat" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="JadPemTglMul" class="form-control datepicker" id="JadPemTglMul">
                </div>
              </div>
              <div class="form-group">
                <label for="JadPemTglSel" class="col-sm-2 control-label">Tanggal Selesai</label>
                <div class="col-sm-9">
                  <input type="text" name="JadPemTglSel" class="form-control datepicker" id="JadPemTglSel">
                </div>
              </div>
              <div class="form-group">
                <label for="JadPemCatatan" class="col-sm-2 control-label">Catatan</label>
                <div class="col-sm-9">
                  <input type="text" name="JadPemCatatan" class="form-control" id="JadPemCatatan" onkeyup="this.value = this.value.toUpperCase();">
                </div>
              </div>
              <div class="form-group">
