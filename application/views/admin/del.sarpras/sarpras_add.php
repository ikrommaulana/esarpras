      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open_multipart(base_url('admin/sarpras/add'), 'class="form-horizontal"');  ?> 
              <div class="form-group">
                <label for="nup_sarpras" class="col-sm-2 control-label">NUP Sarpras</label>
                <div class="col-sm-9">
                  <input type="text" name="nup_sarpras" class="form-control" id="nup_sarpras" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="nama_sarpras" class="col-sm-2 control-label">Nama Sarpras</label>
                <div class="col-sm-9">
                  <input type="text" name="nama_sarpras" class="form-control" id="nama_sarpras" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="spesifikasi" class="col-sm-2 control-label">Spesifikasi</label>
                <div class="col-sm-9">
                  <input type="text" name="spesifikasi" class="form-control" id="spesifikasi" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="fungsi" class="col-sm-2 control-label">Fungsi</label>
                <div class="col-sm-9">
                  <input type="text" name="fungsi" class="form-control" id="fungsi" placeholder="">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="id_kontrak" class="form-control">
                    ...
                    <option value="<?=$row->id_kontrak;?>"><?=$row->kode_kontrak;?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-md-11">
                  <input type="submit" name="submit" value="Add Sapras" class="btn btn-info pull-right">
                </div>
              </div>
            <?php echo form_close( ); ?>
          </div>
