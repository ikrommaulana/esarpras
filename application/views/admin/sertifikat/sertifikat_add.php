      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/sertifikat/add'), 'class="form-horizontal"');  ?> 
              <div class="form-group">
                <label for="kode_sertifikat" class="col-sm-2 control-label">Kode Sertifikat</label>
                <div class="col-sm-9">
                  <input type="text" name="kode_sertifikat" class="form-control" id="kode_sertifikat" placeholder=""  onkeyup="this.value = this.value.toUpperCase()">
                </div>
              </div>
              <div class="form-group">
                <label for="fungsi_sertifikat" class="col-sm-2 control-label">Fungsi Sertifikat</label>
                <div class="col-sm-9">
                  <input type="text" name="fungsi_sertifikat" class="form-control" id="fungsi_sertifikat" placeholder="">
                </div>
              </div>
              <div class="form-group">
