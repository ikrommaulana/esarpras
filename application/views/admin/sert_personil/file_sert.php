...
$id_personil = $getpeg['id_personil'];
...
<link rel="stylesheet" href="<?= base_url() ?>public/plugins/datatables/dataTables.bootstrap.css">  
 ...
 <section class="content">
    ...
    <div class="col-md-12">
      <div class="box box-body">
        ...
        <div class="col-md-6 text-right">
          <a href="<?= base_url().'admin/personil/edit/'.$id_personil; ?>" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Kembali</a>
        </div>
  ...
  <?php 
    echo $file_sert = base_url().'uploads/images/sert_personil/'.$sert['sertpsscan'];
  ?>
